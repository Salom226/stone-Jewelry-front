  ...
  <div class="container">
    ...
    <form @submit.prevent="submitForm">
      <div class="form-group">
        ...
        <input type="text" v-model="form.firstName" class="form form-control" id="firstName" placeholder="Votre prénom"
          required />
      </div>

      <div class="form-group">
        <label for="lastName">Nom</label>
        <input type="text" v-model="form.lastName" class="form form-control" id="lastName" placeholder="Votre nom"
          required />
      </div>

      <div class="form-group">
        <label for="email">Email</label>
        <input type="email" v-model="form.email" class="form form-control" id="email" placeholder="Votre email"
          required />
      </div>

      <div class="form-group">
        <label for="phone">Téléphone</label>
        <input type="text" v-model="form.phone" class="form form-control" id="phone" placeholder="Votre téléphone"
          required />
      </div>

      <div class="form-group">
        <label for="adress">Adresse</label>
        <input type="text" v-model="form.adress" class="form form-control" id="adress" placeholder="Votre adresse"
          required />
      </div>
